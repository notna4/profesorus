    ...
    return (
        <div style={{ width: "100%" }}>
            <div style={{ marginTop: "10px", marginLeft: "30px", display: "flex", justifyContent: "flex-start", alignItems: "center" }}>
                ...
                <h1 style={{ fontSize: "small", backgroundColor: "white", marginLeft: "10px", color: "#1C1C1C", padding: "5px", paddingLeft: "10px", paddingRight: "10px", borderRadius: "20px" }}>{check ? "bifat" : "programat"}</h1>
            </div>
